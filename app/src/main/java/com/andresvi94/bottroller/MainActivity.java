...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggleBtn = (ToggleButton)findViewById(R.id.scan);
        ...
        if (mBTArrayAdapter == null) {
            ...
            mCMD.addTextChangedListener(new TextWatcher() {
                @Override
    ...
    private void discover(View view){
        ...
        final int result = 1;
        //Used to pass information between activities
        //getJoyStickIntent.putExtra("callingActivity", "MainActivity");

        //startActivityForResult(getJoyStickIntent, result); //used to get result from other activity
